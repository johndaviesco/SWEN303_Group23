...
//- Includong listing view
include components/listingview

doctype html
html(ng-app="listingsViews", lang="en")
	head
		meta(charset="UTF-8")
		...
		block styles
			...
			link(rel="stylesheet",href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css")
			+bootswatch("flatly")
	body(ng-controller="mainController", data-spy="scroll",data-target=".scrollspy")
		block body
		...
		block scripts
			...
			script(src="https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.3.12/angular.min.js")
